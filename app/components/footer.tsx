      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-600">MCServer is a modern Minecraft community offering unique gameplay experiences and regular events.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-4">Quick Links</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/rules" className="text-gray-600 hover:text-emerald-600">Server Rules</Link></li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
          <p>&copy; 2023 MCServer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
